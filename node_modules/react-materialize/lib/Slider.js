...
function (_Component) {
  ...
  function Slider(props) {
    ...
    _this.initSlider = _this.initSlider.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.fullscreenReset = _this.fullscreenReset.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.setActiveIndex = _this.setActiveIndex.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
